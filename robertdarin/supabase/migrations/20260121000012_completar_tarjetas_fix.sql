-- ═══════════════════════════════════════════════════════════════════════════
-- MIGRACIÓN: Completar Sistema de Tarjetas (fix vista)
-- Fecha: 2026-01-21
-- ═══════════════════════════════════════════════════════════════════════════

-- 1. Vista unificada para facilitar consultas (corregida)
DROP VIEW IF EXISTS v_tarjetas_cliente;
...
-- 2. Agregar permisos granulares para tarjetas (si no existen)
...
-- 3. Asignar permisos de tarjetas a superadmin y admin
...
-- 4. Asignar permiso ver_tarjetas a cliente
INSERT INTO roles_permisos (rol_id, permiso_id)
SELECT r.id, p.id
FROM roles r
CROSS JOIN permisos p
